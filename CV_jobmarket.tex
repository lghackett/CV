...
%Subsidence is a prevalent and worsening phenomenon worldwide. 
%We estimate the costs of both plot-level subsidence and uneven neighborhood sinking through the housing market, quantifying the damages to private housing units and public infrastructure. 
...
%Our model highlights that while realizations of subsidence attract development by lowering the opportunity cost of re-building units, expected future sinking deters development if predictable risk is capitalized into home values. 
...
\textbf{``If you build it will they come? Road rehabilitation and transportation supply in Rwanda''} with Marco Gonzalez-Navarro, Florence Kondylis, John Loeser, and Maria Ruth Jones\\ 
...
\begin{mysec} 
    ...
    2025 \>\> \tabfill{North American Meeting of the Urban Economics Association  (\textit{upcoming})} \\
