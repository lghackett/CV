...
\vspace{10mm}
{ Research Economist \hfill Economic Research Division, Banco de México} \\\hrule  \vspace{10mm}
...
lucy.hackettg [at] banxico.org.mx \\
...
PhD, Agricultural and Resource Economics, May 2026 \\
...
\begin{minipage}[t]{0.8\linewidth}
\begin{mysec} 
    2026 \>\>\tabfill{CAF Development Bank, Housing in LAC research grant (\$15,000)}\\ 
...
\end{minipage}\hspace{0.05\linewidth}
\begin{minipage}[t]{0.8\linewidth}
\textit{``Land Subsidence: Environmental risk in housing markets in Mexico City''} (\textsc{Job Market Paper}), with Carolina Rodríguez Zamora \\ 

\textit{``Estimating the Gains from Water Trade: A Systematic
...
\emph{Forthcoming in the Review of Environmental Economics and Policy.} \\

\textit{``Facilitated Enrollment in public health insurance: Effects on prenatal care and birth outcomes''} with Janet Currie and Fernanda Márquez Padilla \\ 
\emph{Forthcoming in the Journal of Labor Economics.} \\
\end{minipage}\vspace{5mm}
...
\end{minipage}\hspace{0.05\linewidth}
\begin{minipage}[t]{0.8\linewidth}
\textit{``Sprawl and the costs and benefits of promoting compact cities: Evidence from Mexico''} with Rodolfo Oviedo Moguel \\ 

\textit{``The hidden costs of intermittent water: Evidence from Jordan''} with Bailey Palmer and Abdulrazzak Tamim\\ 

\textit{``Rural road upgrading and transportation in Rwanda''} with Marco Gonzalez-Navarro, Florence Kondylis, John Loeser, and Maria Ruth Jones\\ 

\textit{``Differential subsidence, damages, and fragility: Evidence from a systematic analysis of structural vulnerability in Mexico City''} with Enrique Fernández-Torres\\ 
\end{minipage}\\ 
%%% TALKS
\begin{minipage}[t]{0.1\linewidth}
\textbf{Talks}
...
\begin{minipage}[t]{0.8\linewidth}
\begin{mysec} 
    2026 \>\> \tabfill{NBER Summer Institute, Urban Economics} \\
    2026 \>\> \tabfill{World Bank Urbanization and Development Conference} \\
    2025 \>\> \tabfill{NEUDC} \\
